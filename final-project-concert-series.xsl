 ...
 <xsl:output method="html" />
  ...
  <html>
    ...
    <table>
      ...
      <tr bgcolor="gray">
        <th>Event Name</th><th>Ticket Price</th><th>Band Name</th><th>Genre</th>
      </tr>
      ...
      <xsl:for-each select="ConcertSeries/Event">
        ...
        <tr bgcolor="{$bgColor}">
          ...
          <!-- &#xA0; = space -->
          <td>$<xsl:value-of select="TicketPrice" />&#xA0;
              <xsl:value-of select="TicketPrice/@currency" /></td>
          <td><xsl:value-of select="BandName" /></td>
          <td><xsl:value-of select="BandGenre" /></td>
        </tr>
